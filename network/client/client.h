...
# define CLIENT_WARN_UNUSED __attribute__((warn_unused_result))
...
client_tcp_send_sync(client_tcp_t *client,
                     buffer_t *buffer, size_t buffer_start) CLIENT_WARN_UNUSED;
...
client_udp_send_sync(client_udp_t *client,
                     buffer_t *buffer, size_t buffer_start,
                     const char *addr, const char *port) CLIENT_WARN_UNUSED;
